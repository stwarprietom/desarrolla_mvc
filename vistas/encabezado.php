...
<html lang="en">
  ...
  <body class="app sidebar-mini">
    <!-- Navbar-->
    <header class="app-header"><a class="app-header__logo" href="">inventario</a>
    ...
    <aside class="app-sidebar">
      //<div class="app-sidebar__user">
        <div>
          <p class="app-sidebar__user-name">Stwar Prieto</p>
      ...
      <ul class="app-menu">
        ...
        <li class="treeview"><a class="app-menu__item" href="#" data-toggle="treeview"><i class="app-menu__icon fa fa-laptop"></i><span class="app-menu__label">Productos</span><i class="treeview-indicator fa fa-angle-right"></i></a>
          <ul class="treeview-menu">
            <li><a class="treeview-item" href="?c=producto"><i class="icon fa fa-circle-o"></i> 
            listar</a></li>
            <li><a class="treeview-item" href="?c=producto&a=FormCrear"  rel="noopener"><i class="icon fa fa-circle-o"></i> Insertar</a></li>
